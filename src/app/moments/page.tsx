...
function MomentImageThumb({
  ...
  if (!shouldUseNextImage(src)) {
    return (
      /* biome-ignore lint/performance/noImgElement: arbitrary remote moment images are content-driven and may not be whitelisted for next/image */
      <img
        src={src}
        alt={alt}
        width={width}
